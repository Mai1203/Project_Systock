...
"}")
        ...
        self.LabelCajaMontoTotal = QtWidgets.QLabel(parent=self.widget_3)
...
"")
        ...
        self.BtnCajaImprimir = QtWidgets.QToolButton(parent=self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.gridLayout.addWidget(self.BtnCajaImprimir, 0, 2, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)
