...
class Ui_Facturas(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_3.addWidget(
            self.TablaFacturas, 0, QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter
        )
        ...
        self.BtnVerProductos.setStyleSheet(
            "QToolButton {\n"
            "    background-color: black; /* Fondo blanco */\n"
            "    border: none; /* Sin borde ni decoración inicial */\n"
            "    color:  white;\n"
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("assets/iconos/proteccion.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.BtnVerCancelarVenta.setStyleSheet(
            "QToolButton {\n"
            "    background-color: black; /* Fondo blanco */\n"
            "    border: none; /* Sin borde ni decoración inicial */\n"
            "    color:  white;\n"
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap("assets/iconos/cerrar.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
