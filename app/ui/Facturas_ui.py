...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.TablaFacturas.sizePolicy().hasHeightForWidth()
        )
        ...
        self.BtnFacturaPagada.setStyleSheet(
            "QToolButton {\n"
            "    background-color: black; /* Fondo blanco */\n"
            "    border: none; /* Sin borde ni decoración inicial */\n"
            "    color:  white;\n"
        ...
        self.BtnEliminarFactura.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonTextBesideIcon
        )
