...
class Ui_Login(object):
    def setupUi(self, CONTENEDEDOR1):
        ...
        self.InputNombreUsuario.setStyleSheet(
            "QLineEdit {\n"
        ...
        spacerItem1 = QtWidgets.QSpacerItem(
            10, 120, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed
        )
        ...
        self.InputPassword.setAlignment(
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("assets/iconos/ojo_cerrado.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        spacerItem3 = QtWidgets.QSpacerItem(
            20, 220, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed
        )
    ...
    def retranslateUi(self, CONTENEDEDOR1):
        ...
        self.InputNombreUsuario.setPlaceholderText(
            _translate("CONTENEDEDOR1", "Usuario")
        )
