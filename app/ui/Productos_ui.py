# Form implementation generated from reading ui file 'd:\SYSTOCK\SYSTOCK\DESARROLLO\python\programacion_ladynails\Project_LadyNails\app\ui\Productos.ui'
#
...
"}")
        ...
        self.lineEdit_4 = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_4, 5, 5, 1, 1)
...
"}")
        ...
        self.tableWidget.setMinimumSize(QtCore.QSize(1300, 600))
        font = QtGui.QFont()
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "Precio Unitario"))
        self.label.setText(_translate("Form", "Cantidad"))
        self.label_2.setText(_translate("Form", "Cantidad Max."))
        self.label_7.setText(_translate("Form", "Categoria"))
        self.label_6.setText(_translate("Form", "Marca"))
        self.label_5.setText(_translate("Form", "Producto"))
        self.LabelVentasA.setText(_translate("Form", "Productos"))
        self.label_3.setText(_translate("Form", "Codigo"))
        self.label_10.setText(_translate("Form", "Precio al por Mayor"))
        self.pushButton_3.setText(_translate("Form", "Agregar Producto"))
        self.label_8.setText(_translate("Form", "Cantidad Min."))
        self.label_4.setText(_translate("Form", "Precio Compra"))
        ...
        item.setText(_translate("Form", "CMin"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "CMax"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "CP"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("Form", "PU"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("Form", "PAM"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("Form", "GU"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("Form", "GAM"))
