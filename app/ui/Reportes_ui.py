...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("d:\\SYSTOCK\\SYSTOCK\\DESARROLLO\\python\\programacion_ladynails\\Project_LadyNails\\app\\ui\\../../assets/iconos/pdf.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.BtnTiempoCaja.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
...
"")
        ...
        self.BtnReporteCaja.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
...
"")
        ...
        self.BtnReporteProducto.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
...
"}")
        ...
        self.BtnReporteAnalisis.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
...
"")
        ...
        self.BtnTiempoAnalisis.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
