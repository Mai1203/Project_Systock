...
"}")
        ...
        self.horizontalLayout_3.addWidget(self.BtnRespaldoExportar, 0, QtCore.Qt.AlignHCenter)
...
"}")
        ...
        self.horizontalLayout_3.addWidget(self.BtnRespaldoImportar, 0, QtCore.Qt.AlignHCenter)
