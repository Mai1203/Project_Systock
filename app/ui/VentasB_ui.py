# Form implementation generated from reading ui file 'd:\SYSTOCK\SYSTOCK\DESARROLLO\python\programacion_ladynails\Project_LadyNails\app\ui\VentasB.ui'
#
...
"")
        ...
        self.InputPrecioUnitario_2 = QtWidgets.QLineEdit(parent=self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.InputPrecioUnitario_2.sizePolicy().hasHeightForWidth())
        self.InputPrecioUnitario_2.setSizePolicy(sizePolicy)
        self.InputPrecioUnitario_2.setMinimumSize(QtCore.QSize(250, 50))
        self.InputPrecioUnitario_2.setMaximumSize(QtCore.QSize(250, 50))
        self.InputPrecioUnitario_2.setStyleSheet("")
        self.InputPrecioUnitario_2.setObjectName("InputPrecioUnitario_2")
        self.gridLayout_4.addWidget(self.InputPrecioUnitario_2, 2, 5, 1, 1)
